                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <h2 >MSLA</h2>
                                                            <div style={{ display: "flex", alignItems: "center" }}>
                                                                ...
                                                                <p>{entity.MSLA}</p>
                                                                <span style={{ marginLeft: "10px", fontSize: "1rem", fontWeight: "bolder", marginBottom: "1rem" }}><i className="fa fa-eye" aria-hidden="true"></i><i className="fa fa-download" aria-hidden="true"></i></span>
